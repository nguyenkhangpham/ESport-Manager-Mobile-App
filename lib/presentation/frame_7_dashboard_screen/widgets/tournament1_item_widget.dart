...
class Tournament1ItemWidget extends StatelessWidget {
  Tournament1ItemWidget(this.tournament1ItemModelObj);

  Tournament1ItemModel tournament1ItemModelObj;
